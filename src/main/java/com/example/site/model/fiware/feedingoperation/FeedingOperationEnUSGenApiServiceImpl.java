...
import com.example.site.model.fiware.feedingoperation.FeedingOperationPage;
		...
		user(serviceRequest, SiteRequest.class, SiteUser.class, SiteUser.getClassApiAddress(), "postSiteUserFuture", "patchSiteUserFuture").onSuccess(siteRequest -> {
			webClient.post(
					...
					.sendForm(MultiMap.caseInsensitiveMultiMap()
							...
							.add("permission", String.format("%s#%s", FeedingOperation.CLASS_SIMPLE_NAME, config.getString(ComputateConfigKeys.AUTH_SCOPE_ADMIN)))
							.add("permission", String.format("%s#%s", FeedingOperation.CLASS_SIMPLE_NAME, config.getString(ComputateConfigKeys.AUTH_SCOPE_SUPER_ADMIN)))
							.add("permission", String.format("%s#%s", FeedingOperation.CLASS_SIMPLE_NAME, "GET"))
							.add("permission", String.format("%s#%s", FeedingOperation.CLASS_SIMPLE_NAME, "POST"))
							.add("permission", String.format("%s#%s", FeedingOperation.CLASS_SIMPLE_NAME, "DELETE"))
							.add("permission", String.format("%s#%s", FeedingOperation.CLASS_SIMPLE_NAME, "PATCH"))
							.add("permission", String.format("%s#%s", FeedingOperation.CLASS_SIMPLE_NAME, "PUT"))
