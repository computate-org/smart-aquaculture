 ...
 * Fiware: true
 * Order: 6
 * Description.enUS: A fishing dock
 * Description.frFR: Un quai de pêche
 * AName.enUS: a fishing dock
 * AName.frFR: un quai de pêche
 ...
 *   SearchPageFrFR:
 *     Language: frFR
 *     Page: FishingDockPage
 *     ApiUri: /fr-fr/rechercher/quai-de-peche
 *   EditPageFrFR:
 *     Language: frFR
 *     Page: FishingDockPage
 *     ApiUri: /fr-fr/edition/quai-de-peche/{entityShortId}
 *   Search:
 *   GET:
 *   PATCH:
 *   POST:
...
public class FishingDock extends FishingDockGen<MapModel> {
   ...
   * Description.enUS: The local time zone of the dock. 
   * Description.frFR: Le fuseau horaire local du quai. 
   * HtmRow: 3
   * HtmCell: 1
   * Facet: true
   * Zone: true
