...
/**
 * Order: 11
 * Description.enUS: A fishing trip
 * Description.frFR: Une sortie de pêche
 * AName.enUS: a fishing trip
 * AName.frFR: une sortie de pêche
 ...
 *   SearchPageFrFR:
 *     Language: frFR
 *     Page: FishingTripPage
 *     ApiUri: /fr-fr/rechercher/sortie-de-peche
 *   EditPageFrFR:
 *     Language: frFR
 *     Page: FishingTripPage
 *     ApiUri: /fr-fr/edition/sortie-de-peche/{entityShortId}
 *   Search:
 *   GET:
 *   PATCH:
 *   POST:
...
public class FishingTrip extends FishingTripGen<MapModel> {
	 ...
	 * Description.frFR: Le fuseau horaire local sur lequel sont basées les dates de départ et d'arrivée de la sortie de pêche. 
	 ...
	 * Description.frFR: La date et l'heure de départ de la sortie de pêche. 
	 * HtmColumn: 1
	 * HtmRow: 3
	 * HtmCell: 1
	 * Facet: true
	 ...
	 * Description.frFR: La date et l'heure de retour de la sortie de pêche. 
	 * HtmColumn: 2
	 * HtmRow: 3
	 * HtmCell: 2
	 * Facet: true
