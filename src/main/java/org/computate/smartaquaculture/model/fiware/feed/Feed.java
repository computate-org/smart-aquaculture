 ...
 *
 * Order: 13
 * Description.enUS: Feed tak for a group of animals
 * Description.frFR: Nourriture pour un groupe d'animaux
 * AName.enUS: a feed
 * AName.frFR: une nourriture
 ...
 *     Language: frFR
 *     Page: FeedPage
 *     ApiUri: /fr-fr/rechercher/nourriture
 *   EditPageFrFR:
 *     Language: frFR
 *     Page: FeedPage
 *     ApiUri: /fr-fr/edition/nourriture/{entityShortId}
 *   Search:
 *   GET:
 *   PATCH:
 *   POST:
...
public class Feed extends FeedGen<BaseModel> {
   ...
   * Description.frFR: Le nom de cet élément
   ...
   * Description.frFR: Une description de cet élément
	 * HtmColumn: 2
	 * VarDescription: true
	 * HtmRow: 3
	 * HtmCell: 1
   ...
   * Description.frFR: Le NGSILD-Path ou Fiware-ServicePath
	 ...
	 * Description.frFR: Horodatage de création de l'entité. Cela sera généralement alloué par la plateforme de stockage
	 * HtmRow: 6
	 * HtmCell: 3
	 * Facet: true
	 **/
	 ...
	 * Description.frFR: liste d'uri pointant vers des ressources supplémentaires sur l'article
	 * HtmRow: 6
	 * HtmCell: 7
	 * Facet: true
	 **/
