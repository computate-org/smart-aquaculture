...
/**
 * Order: 8
 * Description.enUS: A fish farm
 * Description.frFR: Une ferme piscicole
 * AName.enUS: a fish farm
 * AName.frFR: une ferme piscicole
 ...
 *     Language: frFR
 *     Page: FishFarmPage
 *     ApiUri: /fr-fr/rechercher/ferme-piscicole
 *   EditPageFrFR:
 *     Language: frFR
 *     Page: FishFarmPage
 *     ApiUri: /fr-fr/edition/ferme-piscicole/{entityShortId}
 *   Search:
 *   GET:
 *   PATCH:
 *   POST:
