...
public class FishProcessingEnUSGenApiServiceImpl extends BaseApiServiceImpl implements FishProcessingEnUSGenApiService {
        ...
        searchFishProcessingList(siteRequest, false, true, true).onSuccess(listFishProcessing -> {
          try {
            ...
            if(o != null) {
              ...
              apiRequest.setId(Optional.ofNullable(listFishProcessing.first()).map(o3 -> o3.getEntityShortId().toString()).orElse(null));
              apiRequest.setSolrId(Optional.ofNullable(listFishProcessing.first()).map(o3 -> o3.getSolrId()).orElse(null));
              JsonObject jsonObject = JsonObject.mapFrom(o);
              o2 = jsonObject.mapTo(FishProcessing.class);
              ...
              String m = String.format("%s %s not found", "fish processing plant", null);
      ...
      for(String entityVar : methodNames) {
        switch(entityVar) {
          ...
          case "setDisplayPageFrFR":
              ...
              if(bParams.size() > 0)
                bSql.append(", ");
              bSql.append(FishProcessing.VAR_displayPageFrFR + "=$" + num);
              num++;
          ...
          case "setEditPage":
              ...
              if(bParams.size() > 0)
                bSql.append(", ");
              bSql.append(FishProcessing.VAR_editPage + "=$" + num);
              num++;
          ...
          case "setEditPageFrFR":
              ...
              if(bParams.size() > 0)
                bSql.append(", ");
              bSql.append(FishProcessing.VAR_editPageFrFR + "=$" + num);
              num++;
          ...
          case "setUserPage":
              ...
              if(bParams.size() > 0)
                bSql.append(", ");
              bSql.append(FishProcessing.VAR_userPage + "=$" + num);
              num++;
          ...
          case "setUserPageFrFR":
              ...
              if(bParams.size() > 0)
                bSql.append(", ");
              bSql.append(FishProcessing.VAR_userPageFrFR + "=$" + num);
              num++;
          ...
          case "setDownload":
              ...
              if(bParams.size() > 0)
                bSql.append(", ");
              bSql.append(FishProcessing.VAR_download + "=$" + num);
              num++;
          ...
          case "setDownloadFrFR":
              ...
              if(bParams.size() > 0)
                bSql.append(", ");
              bSql.append(FishProcessing.VAR_downloadFrFR + "=$" + num);
              num++;
      ...
      if(jsonObject != null) {
        ...
        for(String entityVar : entityVars) {
          ...
          case FishProcessing.VAR_displayPage:
            ...
            bParams.add(o2.sqlDisplayPage());
            break;
          case FishProcessing.VAR_displayPageFrFR:
            o2.setDisplayPageFrFR(jsonObject.getString(entityVar));
            if(bParams.size() > 0) {
              bSql.append(", ");
            }
            ...
            bParams.add(o2.sqlDisplayPageFrFR());
            break;
          case FishProcessing.VAR_editPage:
            o2.setEditPage(jsonObject.getString(entityVar));
            if(bParams.size() > 0) {
              bSql.append(", ");
            }
            ...
            bParams.add(o2.sqlEditPage());
            break;
          case FishProcessing.VAR_editPageFrFR:
            o2.setEditPageFrFR(jsonObject.getString(entityVar));
            if(bParams.size() > 0) {
              bSql.append(", ");
            }
            ...
            bParams.add(o2.sqlEditPageFrFR());
            break;
          case FishProcessing.VAR_userPage:
            o2.setUserPage(jsonObject.getString(entityVar));
            if(bParams.size() > 0) {
              bSql.append(", ");
            }
            ...
            bParams.add(o2.sqlUserPage());
            break;
          case FishProcessing.VAR_userPageFrFR:
            o2.setUserPageFrFR(jsonObject.getString(entityVar));
            if(bParams.size() > 0) {
              bSql.append(", ");
            }
            ...
            bParams.add(o2.sqlUserPageFrFR());
            break;
          case FishProcessing.VAR_download:
            o2.setDownload(jsonObject.getString(entityVar));
            if(bParams.size() > 0) {
              bSql.append(", ");
            }
            ...
            bParams.add(o2.sqlDownload());
            break;
          case FishProcessing.VAR_downloadFrFR:
            o2.setDownloadFrFR(jsonObject.getString(entityVar));
            if(bParams.size() > 0) {
              bSql.append(", ");
            }
    ...
    user(serviceRequest, SiteRequest.class, SiteUser.class, SiteUser.getClassApiAddress(), "postSiteUserFuture", "patchSiteUserFuture", classPublicRead).onSuccess(siteRequest -> {
      try {
        ...
        pgPool.getConnection().onSuccess(sqlConnection -> {
          String sqlQuery = String.format("select * from %s WHERE entityShortId=$1", FishProcessing.CLASS_SIMPLE_NAME);
  ...
  public String templateUriSearchPageFishProcessing(ServiceRequest serviceRequest, FishProcessing result) {
    return "en-us/search/fish-processing/FishProcessingSearchPage.htm";
  }
  public void templateSearchPageFishProcessing(JsonObject ctx, FishProcessingPage page, SearchList<FishProcessing> listFishProcessing, Promise<String> promise) {
    try {
      SiteRequest siteRequest = listFishProcessing.getSiteRequest_(SiteRequest.class);
      ...
      LOG.error(String.format("templateSearchPageFishProcessing failed. "), ex);
    ...
    try {
      ...
      page.promiseDeepFishProcessingPage(siteRequest).onSuccess(a -> {
        try {
          ...
          searchpageFishProcessingPageInit(ctx, page, listFishProcessing, promise1);
          promise1.future().onSuccess(b -> {
            Promise<String> promise2 = Promise.promise();
            templateSearchPageFishProcessing(ctx, page, listFishProcessing, promise2);
  ...
  public String templateUriEditPageFishProcessing(ServiceRequest serviceRequest, FishProcessing result) {
    return "en-us/edit/fish-processing/FishProcessingEditPage.htm";
  }
  public void templateEditPageFishProcessing(JsonObject ctx, FishProcessingPage page, SearchList<FishProcessing> listFishProcessing, Promise<String> promise) {
    try {
      SiteRequest siteRequest = listFishProcessing.getSiteRequest_(SiteRequest.class);
      ServiceRequest serviceRequest = siteRequest.getServiceRequest();
      FishProcessing result = listFishProcessing.first();
      ...
      LOG.error(String.format("templateEditPageFishProcessing failed. "), ex);
      ExceptionUtils.rethrow(ex);
    }
  }
    ...
    try {
      ...
      page.promiseDeepFishProcessingPage(siteRequest).onSuccess(a -> {
        try {
          ...
          ctx.mergeIn(JsonObject.mapFrom(page));
          Promise<Void> promise1 = Promise.promise();
          editpageFishProcessingPageInit(ctx, page, listFishProcessing, promise1);
          promise1.future().onSuccess(b -> {
            Promise<String> promise2 = Promise.promise();
            templateEditPageFishProcessing(ctx, page, listFishProcessing, promise2);
            promise2.future().onSuccess(renderedTemplate -> {
              try {
                Buffer buffer = Buffer.buffer(renderedTemplate);
                promise.complete(new ServiceResponse(200, "OK", buffer, requestHeaders));
  ...
  public Future<JsonObject> generatePageBody(ComputateSiteRequest siteRequest, Map<String, Object> ctx, String templatePath, String classSimpleName, String pageTemplate) {
    ...
    try {
      ...
      o.persistForClass(FishProcessing.VAR_editPage, FishProcessing.staticSetEditPage(siteRequest2, (String)result.get(FishProcessing.VAR_editPage)));
      o.persistForClass(FishProcessing.VAR_editPageFrFR, FishProcessing.staticSetEditPageFrFR(siteRequest2, (String)result.get(FishProcessing.VAR_editPageFrFR)));
      o.persistForClass(FishProcessing.VAR_userPage, FishProcessing.staticSetUserPage(siteRequest2, (String)result.get(FishProcessing.VAR_userPage)));
      o.persistForClass(FishProcessing.VAR_userPageFrFR, FishProcessing.staticSetUserPageFrFR(siteRequest2, (String)result.get(FishProcessing.VAR_userPageFrFR)));
      o.persistForClass(FishProcessing.VAR_download, FishProcessing.staticSetDownload(siteRequest2, (String)result.get(FishProcessing.VAR_download)));
      o.persistForClass(FishProcessing.VAR_downloadFrFR, FishProcessing.staticSetDownloadFrFR(siteRequest2, (String)result.get(FishProcessing.VAR_downloadFrFR)));
