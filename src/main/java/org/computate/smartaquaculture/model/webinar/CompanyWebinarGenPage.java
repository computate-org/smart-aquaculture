...
public class CompanyWebinarGenPage extends CompanyWebinarGenPageGen<PageLayout> {
  ...
  protected void _pageResponse(Wrap<String> w) {
    if(searchListCompanyWebinar_ != null)
      w.o(Optional.ofNullable(searchListCompanyWebinar_.getResponse()).map(response -> JsonObject.mapFrom(response).toString()).orElse(null));
  }

  @Override
  protected void _stats(Wrap<SolrResponse.Stats> w) {
    w.o(Optional.ofNullable(searchListCompanyWebinar_.getResponse()).map(response -> response.getStats()).orElse(null));
  }

  @Override
  protected void _facetCounts(Wrap<SolrResponse.FacetCounts> w) {
    w.o(Optional.ofNullable(searchListCompanyWebinar_.getResponse()).map(response -> response.getFacetCounts()).orElse(null));
  }
  ...
  protected void _pagination(JsonObject pagination) {
    ...
    Long foundNum = Optional.ofNullable(searchListCompanyWebinar_.getResponse()).map(response -> response.getResponse().getNumFound().longValue()).orElse(Long.valueOf(searchListCompanyWebinar_.getList().size()));
  ...
  protected void _varsFq(JsonObject vars) {
    ...
    for(String var : CompanyWebinar.varsFqForClass()) {
      ...
      if(v != null) {
        ...
        while(mFq.find()) {
          String entityVar = CompanyWebinar.searchVarCompanyWebinar(varIndexed);
  ...
  protected void _query(JsonObject query) {
    ...
    Long num = Optional.ofNullable(searchListCompanyWebinar_.getResponse()).map(response -> response.getResponse().getNumFound().longValue()).orElse(Long.valueOf(searchListCompanyWebinar_.getList().size()));
    String q = "*:*";
  ...
  **/
  ...
  protected void _pageUri(Wrap<String> w) {
    if("enUS".equals(lang))
      ...
      w.o("/fr-fr/rechercher/webinar");
  }

  @Override
  protected void _apiUri(Wrap<String> w) {
    w.o("/en-us/api/webinar");
  }
