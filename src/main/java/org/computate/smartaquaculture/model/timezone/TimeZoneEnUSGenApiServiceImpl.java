...
public class TimeZoneEnUSGenApiServiceImpl extends BaseApiServiceImpl implements TimeZoneEnUSGenApiService {
	...
	public void patchTimeZone(JsonObject body, ServiceRequest serviceRequest, Handler<AsyncResult<ServiceResponse>> eventHandler) {
		...
		user(serviceRequest, SiteRequest.class, SiteUser.class, SiteUser.getClassApiAddress(), "postSiteUserFuture", "patchSiteUserFuture", classPublicRead).onSuccess(siteRequest -> {
			...
			form.add("permission", String.format("%s#%s", TimeZone.CLASS_SIMPLE_NAME, config.getString(ComputateConfigKeys.AUTH_SCOPE_ADMIN)));
			form.add("permission", String.format("%s#%s", TimeZone.CLASS_SIMPLE_NAME, config.getString(ComputateConfigKeys.AUTH_SCOPE_SUPER_ADMIN)));
			form.add("permission", String.format("%s#%s", TimeZone.CLASS_SIMPLE_NAME, "GET"));
			form.add("permission", String.format("%s#%s", TimeZone.CLASS_SIMPLE_NAME, "POST"));
			form.add("permission", String.format("%s#%s", TimeZone.CLASS_SIMPLE_NAME, "DELETE"));
			form.add("permission", String.format("%s#%s", TimeZone.CLASS_SIMPLE_NAME, "PATCH"));
			form.add("permission", String.format("%s#%s", TimeZone.CLASS_SIMPLE_NAME, "PUT"));
			if(id != null)
				form.add("permission", String.format("%s-%s#%s", TimeZone.CLASS_SIMPLE_NAME, id, "PATCH"));
			webClient.post(
	...
	public void postTimeZone(JsonObject body, ServiceRequest serviceRequest, Handler<AsyncResult<ServiceResponse>> eventHandler) {
		...
		user(serviceRequest, SiteRequest.class, SiteUser.class, SiteUser.getClassApiAddress(), "postSiteUserFuture", "patchSiteUserFuture", classPublicRead).onSuccess(siteRequest -> {
			...
			form.add("permission", String.format("%s#%s", TimeZone.CLASS_SIMPLE_NAME, "PUT"));
			if(id != null)
				form.add("permission", String.format("%s-%s#%s", TimeZone.CLASS_SIMPLE_NAME, id, "POST"));
			webClient.post(
					config.getInteger(ComputateConfigKeys.AUTH_PORT)
					, config.getString(ComputateConfigKeys.AUTH_HOST_NAME)
					, config.getString(ComputateConfigKeys.AUTH_TOKEN_URI)
	...
	public void deleteTimeZone(JsonObject body, ServiceRequest serviceRequest, Handler<AsyncResult<ServiceResponse>> eventHandler) {
		...
		user(serviceRequest, SiteRequest.class, SiteUser.class, SiteUser.getClassApiAddress(), "postSiteUserFuture", "patchSiteUserFuture", classPublicRead).onSuccess(siteRequest -> {
			...
			form.add("permission", String.format("%s#%s", TimeZone.CLASS_SIMPLE_NAME, "PUT"));
			if(id != null)
				form.add("permission", String.format("%s-%s#%s", TimeZone.CLASS_SIMPLE_NAME, id, "DELETE"));
			webClient.post(
					config.getInteger(ComputateConfigKeys.AUTH_PORT)
					, config.getString(ComputateConfigKeys.AUTH_HOST_NAME)
					, config.getString(ComputateConfigKeys.AUTH_TOKEN_URI)
	...
	public void putimportTimeZone(JsonObject body, ServiceRequest serviceRequest, Handler<AsyncResult<ServiceResponse>> eventHandler) {
		...
		user(serviceRequest, SiteRequest.class, SiteUser.class, SiteUser.getClassApiAddress(), "postSiteUserFuture", "patchSiteUserFuture", classPublicRead).onSuccess(siteRequest -> {
			...
			form.add("permission", String.format("%s#%s", TimeZone.CLASS_SIMPLE_NAME, "PUT"));
			if(id != null)
				form.add("permission", String.format("%s-%s#%s", TimeZone.CLASS_SIMPLE_NAME, id, "PUT"));
			webClient.post(
					config.getInteger(ComputateConfigKeys.AUTH_PORT)
					, config.getString(ComputateConfigKeys.AUTH_HOST_NAME)
					, config.getString(ComputateConfigKeys.AUTH_TOKEN_URI)
	...
	public void searchpageTimeZonePageInit(TimeZonePage page, SearchList<TimeZone> listTimeZone) {
	}
	...
	public void editpageTimeZone(ServiceRequest serviceRequest, Handler<AsyncResult<ServiceResponse>> eventHandler) {
		...
		user(serviceRequest, SiteRequest.class, SiteUser.class, SiteUser.getClassApiAddress(), "postSiteUserFuture", "patchSiteUserFuture", classPublicRead).onSuccess(siteRequest -> {
			...
			form.add("permission", String.format("%s#%s", TimeZone.CLASS_SIMPLE_NAME, "PUT"));
			if(id != null)
				form.add("permission", String.format("%s-%s#%s", TimeZone.CLASS_SIMPLE_NAME, id, "GET"));
			webClient.post(
					config.getInteger(ComputateConfigKeys.AUTH_PORT)
					, config.getString(ComputateConfigKeys.AUTH_HOST_NAME)
					, config.getString(ComputateConfigKeys.AUTH_TOKEN_URI)
	...
	public void editpageTimeZonePageInit(TimeZonePage page, SearchList<TimeZone> listTimeZone) {
	}
